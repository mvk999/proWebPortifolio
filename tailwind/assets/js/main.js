(() => {
  ...
  const translations = {
    "Página pessoal": "Personal page", "Olá, meu nome é": "Hello, my name is", "Estudante de Ciência da Computação": "Computer Science student", "Formação atual": "Current education", "6º período": "6th semester", "Início": "Home", "Sobre": "About", "Experiências": "Experience", "Experiências profissionais": "Professional experience", "Tecnologias": "Technologies", "Projetos": "Projects", "Formação": "Education", "Contato": "Contact", "Escolher versão": "Choose version", "Conheça os projetos": "Explore the projects", "Linguagens": "Languages", "Desenvolvimento": "Development", "E-mail": "Email", "Ciência da Computação": "Computer Science", "Técnico em Informática Integrado ao Ensino Médio": "Technical Degree in Informatics Integrated with High School", "Universidade Federal de Lavras — UFLA": "Federal University of Lavras — UFLA", "IFSULDEMINAS — Campus Machado": "IFSULDEMINAS — Machado Campus", "Ver repositório": "View repository", "Pular para o conteúdo": "Skip to content",
