(() => {
  ...
  function setupProjectCarousel() {
    ...
    function render(nextIndex) {
      ...
      card.innerHTML = `<p class="project-meta">${project.meta}</p><h3 class="h3">${project.name}</h3><p>${project.description}</p><a href="${project.url}" target="_blank" rel="noopener noreferrer">Ver repositório <span aria-hidden="true">↗</span></a>`;
