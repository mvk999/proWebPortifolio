(() => {
  ...
  const translations = {
    ...
    "Formação atual": "Current education",
    "6º período": "6th semester",
    "Início": "Home",
    "Sobre": "About",
    "Trajetória acadêmica e prática aplicada ao desenvolvimento de software": "Academic path and hands-on software development",
    "Sou Marcos Vinícius Pereira, estudante de Ciência da Computação na Universidade Federal de Lavras (UFLA). Neste portfólio, reúno experiências, projetos e tecnologias que fazem parte da minha trajetória de desenvolvimento.": "I am Marcos Vinícius Pereira, a Computer Science student at the Federal University of Lavras (UFLA). This portfolio brings together the experiences, projects, and technologies that are part of my development journey.",
    "Atuação": "Focus",
    "Desenvolvimento de software": "Software development",
    "Backend, APIs REST e integração entre módulos.": "Backend, REST APIs, and module integration.",
    "Projetos aplicados": "Applied projects",
    "Soluções para Web, dados e aplicações práticas.": "Solutions for Web, data, and practical applications.",
    "Tecnologias em uso": "Technologies in use",
    "Java, Python, JavaScript, SQL e PostgreSQL.": "Java, Python, JavaScript, SQL, and PostgreSQL.",
    "Backend e APIs": "Backend and APIs",
    "APIs · Dados · Web": "APIs · Data · Web",
    ...
    "Formação": "Education",
    "Contato": "Contact",
    "Escolher versão": "Choose version",
    "Conheça os projetos": "Explore the projects",
    "Tecnologias presentes na minha formação e nos projetos reunidos neste portfólio.": "Technologies present in my education and in the projects featured in this portfolio.",
    "Linguagens": "Languages",
    "Desenvolvimento": "Development",
    "Desenvolvedor de Sistemas I": "Systems Developer I",
    "Bolsista em Qualidade de Software e Automação de Testes": "Software Quality and Test Automation Scholarship Holder",
    "Gerente de Projetos e Qualidade": "Project and Quality Manager",
    "ago. 2026 — atual": "Aug. 2026 — present",
    "jun. 2025 — jul. 2026": "Jun. 2025 — Jul. 2026",
    "fev. 2025 — jan. 2026": "Feb. 2025 — Jan. 2026",
    "Desenvolvimento e evolução de um módulo de framework em Java, com integração aos componentes existentes e manutenção do código com foco em reutilização, legibilidade e evolução do sistema.": "Development and evolution of a Java framework module, integrating existing components and maintaining the code with a focus on reuse, readability, and system evolution.",
    "Desenvolvimento backend em Java, APIs REST e integrações entre módulos, além de testes automatizados com Zettalenium e atuação com Git, code review e integração contínua.": "Backend development in Java, REST APIs, and module integrations, along with automated testing using Zettalenium, Git, code review, and continuous integration.",
    "Atuação em projetos backend, acompanhando demandas e validações técnicas, com contribuição em revisão de código, documentação e padronização de processos.": "Work on backend projects, following requirements and technical validations while contributing to code review, documentation, and process standardization.",
    ...
    "E-mail": "Email",
    "Vamos conversar sobre projetos, tecnologia ou oportunidades de colaboração.": "Let's talk about projects, technology, or collaboration opportunities.",
    "Canal direto para contato.": "Direct contact channel.",
    "Perfil profissional e trajetória acadêmica.": "Professional profile and academic background.",
    "Repositórios e projetos públicos.": "Public repositories and projects.",
    "Ciência da Computação": "Computer Science",
    "Técnico em Informática Integrado ao Ensino Médio": "Technical Degree in Informatics Integrated with High School",
    "Universidade Federal de Lavras — UFLA": "Federal University of Lavras — UFLA",
    "IFSULDEMINAS — Campus Machado": "IFSULDEMINAS — Machado Campus",
    "Ferramenta de espelhamento em rede local que usa WebRTC e pareamento por PIN para transmitir a tela do notebook ao navegador de uma Smart TV.": "A local-network screen mirroring tool using WebRTC and PIN pairing to stream a laptop screen to a Smart TV browser.",
    "Projeto de ciência de dados que prepara, valida e explora 1.900 partidas do Campeonato Brasileiro entre 2020 e 2024.": "A data science project that prepares, validates, and explores 1,900 Brazilian Championship matches from 2020 to 2024.",
    "Aplicação Java web de gestão com operações CRUD, persistência em MySQL e implantação em servidor GlassFish.": "A Java web management application with CRUD operations, MySQL persistence, and deployment on a GlassFish server.",
    "API backend desenvolvida para o desafio da Comp Júnior 2025.1, reunindo o gerenciamento de membros, orçamentos e clientes.": "A backend API developed for the Comp Júnior 2025.1 challenge, bringing together member, budget, and client management.",
    "Jogo de cobrinha para a disciplina GAC116 — Programação Web, com controles por teclado, pausas, colisões e reinício de partida.": "A snake game for the GAC116 — Web Programming course, with keyboard controls, pausing, collisions, and game restart.",
  ...
  function setupLanguage() {
    ...
    function applyLanguage(nextLanguage) {
      ...
      candidates.forEach((element) => {
        ...
        element.textContent = language === "en" ? translations[key] : key;
      });
      compound.forEach((element) => {
        const key = element.dataset.languageKey;
        replaceLeadingText(element, language === "en" ? translations[key] : key);
      });
  ...
  function setupProjectCarousel() {
    ...
    function render(nextIndex) {
      ...
      card.innerHTML = `<p class="project-meta">${project.meta}</p><h3 class="h3">${project.name}</h3><p>${project.description}</p><a class="project-link" href="${project.url}" target="_blank" rel="noopener noreferrer">Ver repositório <span aria-hidden="true">↗</span></a>`;
